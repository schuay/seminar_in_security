...
relative to the keysharing graph\footnote{An undirected connected graph $G = (V, E)$ with $|V| = n$ vertices $v_i \in V$ and $|E| = m$ edges $e_{ij} \in E$,
...
$k(e_{ij})$.} and the set of pooled key edges.
...
% TODO: Reinclude the notation somewhere.
